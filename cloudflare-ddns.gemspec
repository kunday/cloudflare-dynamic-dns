...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Update cloudflare dns record, replacement for ddns}
  spec.description   = %q{Kick-ass cloudflare based ddns updater.}
  ...
  spec.add_dependency "cloudflare", "~> 2.1.0"
end
